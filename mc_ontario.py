...
def main(use_range, uuid, burst_length, n_bursts, threshold):
    # fmt: off
    m_orig = np.array(
        [2284,1668,5436,5140,11_109,
            3640,14_170,5210,3921,3679,
            3473,4106,3931,9404,2403,
            6637,3360,2644,1641,15_860,
            2740]
    ) 
    m = ( np.array( 
        [2284,1668,5436,5140,11_109,
    ...
    file_name = f"Ontario_MCMC_discrep_L1_lenburst_{burst_length}_iters_T_{threshold}_{n_bursts}_id_{uuid}.txt"
    if use_range:
        file_name = f"Ontario_MCMC_discrep_range_lenburst_{burst_length}_iters_T_{threshold}_{n_bursts}_id_{uuid}.txt"
